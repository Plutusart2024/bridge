...
export default async function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24" style={{paddingTop: 240 }}>
      <div className="z-10 max-w w-full items-center justify-between font-mono text-sm lg:flex">
        <p className={styles.p_styled}>
          <ul>

          
           
            <li style={{color: "red"}}><b>KK Multi-Chain Bridge</b></li>
            
      
            <li> <Link href="https://meson.fi/" target="_blank">KK Meson</Link></li>
            
            <li> <Link href="https://stargate.finance/transfer" target="_blank">KK LayerZero </Link></li>
            <li style={{color: "red"}}> <Link href="https://jumper.exchange/?fromChain=56&toChain=1" target="_blank">KK Jumper</Link></li>
            <li> <Link href="https://app.odos.xyz/" target="_blank">KK Odos </Link></li>
            <li style={{color: "red"}}> <Link href="https://ecoswap.exchange/" target="_blank">KK Eco </Link></li>

            
            
            <li> <Link href="https://app.rocketx.exchange/swap/BNB.binancecoin/ETHEREUM.ethereum/1?from=Binance&to=Ethereum" target="_blank">KK RocketX Bridge</Link></li>
...
<li className={styles.spaceDouble}> <Link href="https://etherscan.io/address/0x8fB1A35bB6fB9c47Fb5065BE5062cB8dC1687669#writeProxyContract" target="_blank">Skale - L1 Deposit Box</Link></li>
        ...
        <div>
          <p style={{color: "#bbeb78"}}><ConnectWallet /></p>
        </div>
        <div> <p> <Signer /></p></div>
